...
public class Agenda {
	  ...
	  public static void busqueda(Contacto con[]) {
		    Scanner entrada = new Scanner(System.in);
		  int numC;
		  System.out.println();
		  System.out.println("Digite el numero de contacto");
		  numC=entrada.nextInt();
		  System.out.println("Contacto "+(numC));
		  System.out.println("Nombre: "+con[numC-1].getNomb());
		  System.out.println("Numero: "+con[numC-1].getNum());
		  System.out.println("Direccion: "+con[numC-1].getDirecc());
	  }
